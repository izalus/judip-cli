...
exports.sync = function () { return __awaiter(void 0, void 0, void 0, function () {
    var files, dirNames, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, readdir(path_1.default.join(utils_1.getAppDataPath(), 'judip-cli'), {
                        withFileTypes: true,
                    })];
            case 1:
                files = _a.sent();
                ...
                dirNames.forEach(function (name) { return __awaiter(void 0, void 0, void 0, function () {
                    var stdout, err_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, exec('git pull', {
                                        cwd: path_1.default.join(utils_1.getAppDataPath(), 'judip-cli', name),
                                    })];
                            case 1:
