...
exports.getInputs = function (inputs, details) {
    ...
    Object.keys(inputs).forEach(function (key) {
        ...
        var _a = details[key] || {}, _b = _a.element, el = _b === void 0 ? null : _b, _c = _a.label, label = _c === void 0 ? key : _c, _d = _a.placeholder, placeholder = _d === void 0 ? '' : _d, _e = _a.optional, optional = _e === void 0 ? false : _e, _f = _a.value, value = _f === void 0 ? '' : _f;
        if (el) {
            element = el;
        }
        if (element !== null) {
            if (element === 'input' && typeof value === 'string') {
                ...
                input.forEach(function (val, i) {
                    if (typeof val === 'string') {
                        ...
                        options_1[i] = val;
                        isValueSet_1 = value === val;
                        firstValue_1 = i === 0 ? val : firstValue_1;
                    }
                    else {
                        optionLabels_1[i] = val[0];
                        options_1[i] = val[1];
                        isValueSet_1 = value === val[1];
                        firstValue_1 = i === 0 ? val[1] : firstValue_1;
                    }
                });
                res.push({
                    element: element,
                    ...
                    options: options_1,
                    value: isValueSet_1 ? value : firstValue_1,
                    optional: optional,
                    label: label,
                });
            }
                ...
                var isValueSet_2 = false;
                var firstValue_2 = '';
                input.forEach(function (val, i) {
                    var newKey = typeof val === 'string' ? val : val[0];
                    var newValue = typeof val === 'string' ? val : val[1];
                    isValueSet_2 = value === newValue;
                    firstValue_2 = i === 0 ? newValue : firstValue_2;
                ...
                res.push({
                    ...
                    options: options_2,
                    value: isValueSet_2 ? value : firstValue_2,
                    optional: optional,
                    label: label,
                });
            }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log(JSON.stringify(exports.getInputs(inputs, details), null, 2));
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                console.log(err_1);
